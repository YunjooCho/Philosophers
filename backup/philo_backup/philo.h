...
/*   Updated: 2023/03/28 21:03:54 by yunjcho          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
typedef struct s_table
{
	...
	long long		born_time;     //철학자(스레드)가 생성된 시간
	...
	pthread_mutex_t	print_mutex;   //printf() 수행 시 사용하는 뮤텍스
}	t_table;
...
typedef struct s_philo
{
	...
	t_fork			*left_fork;        //철학자가 가지고 있는 포크
	t_fork			*right_fork;       //철학자가 가지고 있는 포크
